...
class SGL_dcsg(BaseModel):
    def __init__(self, data_handler):
        super(SGL_dcsg, self).__init__(data_handler)
        # 原始协同图参数
    ...
    def cal_loss(self, batch_data):
        ...
        user_embeds1, item_embeds1, _ = self.forward(self.keep_rate)
        user_embeds2, item_embeds2, _ = self.forward(self.keep_rate)
        user_cf, item_cf, user_sem, item_sem, user_embeds3, item_embeds3, gate = self.forward(
            1.0, return_channels=True
        )
